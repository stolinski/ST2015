            ...
            <div>
                <main id='appbody' className='main-content'>
                    ...
                    <div className='about-body'>
                        ...
                        <p>
                            Please <a href='/#contact'>contact me</a> if you would like to work on a project together, or just want to chat.
                        </p>
                    </div>

                    <div className='resume'>
                        <span className='fakebuttons'></span>
                        ...
                        <div className='resume-inside'>
                            ...
                            <ul>
                                <li>Wrote, produced and recorded over 700 popular tutorial videos on various topics for Level Up Tuts (www.youtube.com/user/LevelUpTuts) with over 8,550,000 views.</li>
                    ...
                    <p className='res-download'>
                        <a className='btn download' href='/ScottTolinskiResumeAug2015.pdf'>Download Resume PDF</a>
                    </p>
                </main>
            </div>
        );
